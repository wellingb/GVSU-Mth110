...
},
{
  ...
  "number": "1",
  "title": "",
  "body": "  The tortoise and the hare are racing. The tortoise starts at the starting line and runs at a constant speed. The hare also starts at the starting line but runs at a faster pace for several minutes. He then realizes that the tortoise is slow, so he stops to take a nap. When he wakes up, he sees that the tortoise has passed him, so he starts running again to the finish line.    Use the information provided to answer the following questions:    Which animal does each function represent in the graph? Label the graph with \"Tortoise\" and \"Hare\".  Explain your thinking.    A distance and time graph with a constant increasing graph starting at (0,0), and a linear graph that increases, then is constant, and ends increasing.      The graph that is constant represents the tortoise because it is moving at a constant speed. The graph that increases, then is constant, and then increases again represents the hare because it starts off fast, then stops to take a nap, and then starts running again.   "
},
{
  "id": "activities-5-2-2",
  "level": "2",
