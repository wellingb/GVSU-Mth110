...
},
{
  ...
  "number": "1",
  "title": "",
  "body": "  The tortoise and the hare are racing. The tortoise starts at the starting line and runs at a constant speed. The hare also starts at the starting line but runs at a faster pace for several minutes. He then realizes that the tortoise is slow, so he stops to take a nap. When he wakes up, he sees that the tortoise has passed him, so he starts running again to the finish line.    Use the information provided to answer the following questions:    Which animal does each function represent in the graph? Label the graph with \"Tortoise\" and \"Hare\".  Explain your thinking.    A distance and time graph with a constant increasing graph starting at (0,0), and a linear graph that increases, then is constant, and ends increasing.      The graph that has a constant slope represents the tortoise because it is moving at a constant speed. The graph that increases, then is constant, and then increases again represents the hare because it starts off fast, then stops to take a nap, and then starts running again.   "
},
{
  "id": "activities-5-2-2",
  "level": "2",
  ...
  "number": "2",
  "title": "",
  "body": "   This graph shows the relationship between the distance and time for a third animal, the fox.    Tell a story about the fox's journey during the race. Include specific details about time and distance.    A distance and time graph with a constant graph starting at (9,0), a linear graph that increases, then is constant, and ends increasing, and a third graph that starts at (6,0) and is constant      The fox started the race 6 minutes after the tortoise and the hare. The fox ran at a constant speed and won the race.    "
},
{
  "id": "activities-5-3-1",
  "level": "2",
  ...
  "number": "3",
  "title": "",
  "body": "  Here are five statements about the race. Select all the true statements.    A. The fox's distance was always increasing.    B. Between 6 and 10 minutes, the fox was traveling faster than the other animals.    C. When the hare reached 800 meters, the fox was still at the starting line.      A and B are true. C is false because the fox started at 6 minutes, so when the hare reached 800 meters, the fox was already moving.   "
},
{
  "id": "activities-5-3-2",
  "level": "2",
...
},
{
  ...
  "number": "5",
  "title": "",
  "body": "   The graph shows what Wyatt drew to represent the dog's race. How did she do? If it is not correct, tell her story.    Wyatt's graph is incorrect, the dog did not have a head start but started 2 minutes after the tortoise. The dog was tied at 800 meters, but it did not ever decrease its distance. The dog did lose the race.    At least one of the following statements is false Circle the false statement.     A. The dog got a head start but lost the race    B. The dog and tortoise were tied at 800 meters.    C. The dog's distance was decreasing for 3 minutes.      Time and distance graph with tortoise graphed and dog's graph starts at (2,0) and increases for a while, then is constant for several minutes, and then increases again.       Explain your thinking    "
},
{
  "id": "activities-5-4-1",
  "level": "2",
...
},
{
  ...
  "body": " Practice Activity     Find the slope between and .    The slope is .       f(x)=(x-2)          A visual pattern where the number of stars is increasing.   A pattern where at step 1 there is 1 star, at step 2 there are 2 stars, at step 3 there are 4 stars, and at step 4 there are 7 stars.     "
},
{
