...
},
{
  ...
  "number": "2",
  "title": "",
  "body": "  The campus events is collecting $15 general admission ticket per student for the annual spring music festival. .    Independent Variable:    Dependent Variable:      Independent Variable: Number of students attending  Dependent Variable: Total revenue collected   "
},
{
  "id": "activities-3-2-6",
  "level": "2",
...
},
{
  ...
  "body": " Independent and Dependent Variables    An independent variable is an input variable whose value can be chosen freely and does not depend on any other variable in the problem or function. It is the variable that you change or manipulate to see how it affects another variable. A dependent variable is the output variable whose value changes in response to, or depends on, the value of the independent variable. It represents the outcome or the result that you are measuring or calculating in a function or problem.      For the following scenarios, determine what the independent and dependent variables are.     A busy student calculates how taking on extra part-time shifts at a local restaurant decreases their available free time for socializing.    Independent Variable:    Dependent Variable:      Independent Variable: Number of part-time shifts  Dependent Variable: Available free time for socializing      The campus events board charges $15 per general admission ticket for the annual spring music festival. .    Independent Variable:    Dependent Variable:      Independent Variable: Price of general admission ticket  Dependent Variable: Number of tickets sold      A student is trying to determine how the amount of time spent studying affects their test scores.    Independent Variable:    Dependent Variable:        An undergrad tracks their daily caffeine intake from the campus coffee shop to see how it affects their monthly budget.    Independent Variable:    Dependent Variable:        A group of prospective roommates searches for off-campus housing and analyzes how proximity to campus impacts rent prices.    Independent Variable:    Dependent Variable:      Independent Variable: Proximity to campus  Dependent Variable: Rent prices     "
},
{
  "id": "activities-4-2",
  "level": "2",
  ...
  "number": "4",
  "title": "",
  "body": "  An independent variable is an input variable whose value can be chosen freely and does not depend on any other variable in the problem or function. It is the variable that you change or manipulate to see how it affects another variable. A dependent variable is the output variable whose value changes in response to, or depends on, the value of the independent variable. It represents the outcome or the result that you are measuring or calculating in a function or problem.   "
},
{
  "id": "activities-4-3",
  "level": "2",
...
},
{
  ...
  "body": " Interval Notation    Interval Notation: A method to represent a set of real numbers by the numbers that bound them using parentheses and brackets.      Parentheses ( or ): to exclude a boundary number of an interval. When infinity is a boundary, a parentheses is always used.  Bracket [ or ]: to include a boundary number of an interval.      Domain: Interval of all possible inputs.      Range: Interval of all possible outputs.      Find the interval of domain values (x's), and the interval of range values (y's) for the following graphs. Assume any graph that goes to the edge of the image has an arrow on the end.       A partial graph of dotted exponential and linear graphs.   (solid line) Domain:_______________ and Range:_______________   Domain: [1,4) Range: [-3,6)   (dotted curve) Domain:_______________ and Range:_______________   Domain:(-inf, 3] Range: (0,8]         A partial graph of exponential and linear graphs.   (dotted line) Domain:_______________ and Range:_______________   Domain: [-1,6] Range: [-2,5]   (solid curve) Domain:_______________ and Range:_______________   Domain: (1,6) Range: (0,9)       Find the interval of inputs that make the dotted line outputs greater than the outputs of the solid curve in the figure above. Approximate to the nearest half.   (1.5,3.5)      "
},
{
  "id": "activities-5-2",
  "level": "2",
  ...
  "number": "5",
  "title": "",
  "body": "  Interval Notation: A method to represent a set of real numbers by the numbers that bound them using parentheses and brackets.   "
},
{
  "id": "activities-5-3",
  "level": "2",
  ...
  "number": "6",
  "title": "",
  "body": "  Parentheses ( or ): to exclude a boundary number of an interval. When infinity is a boundary, a parentheses is always used.  Bracket [ or ]: to include a boundary number of an interval.   "
},
{
  "id": "activities-5-4",
  "level": "2",
  ...
  "number": "7",
  "title": "",
  "body": "  Domain: Interval of all possible inputs.   "
},
{
  "id": "activities-5-5",
  "level": "2",
  ...
  "number": "8",
  "title": "",
  "body": "  Range: Interval of all possible outputs.   "
},
{
  "id": "activities-5-6",
  "level": "2",
  ...
  "number": "1",
  "title": "",
  "body": "  Find the interval of domain values (x's), and the interval of range values (y's) for the following graphs. Assume any graph that goes to the edge of the image has an arrow on the end.       A partial graph of dotted exponential and linear graphs.   (solid line) Domain:_______________ and Range:_______________   Domain: [1,4) Range: [-3,6)   (dotted curve) Domain:_______________ and Range:_______________   Domain:(-inf, 3] Range: (0,8]         A partial graph of exponential and linear graphs.   (dotted line) Domain:_______________ and Range:_______________   Domain: [-1,6] Range: [-2,5]   (solid curve) Domain:_______________ and Range:_______________   Domain: (1,6) Range: (0,9)       Find the interval of inputs that make the dotted line outputs greater than the outputs of the solid curve in the figure above. Approximate to the nearest half.   (1.5,3.5)     "
},
{
  "id": "activities-6",
  "level": "1",
  ...
  "type": "Worksheet",
  "number": "",
  "title": "LT 1-2 Tortoise and Hare ",
  "body": " LT 1-2 Tortoise and Hare Adapted from Amplify Classroom and \"Beginning Algebra Made Useful\"      The tortoise and the hare are racing. The tortoise starts at the starting line and runs at a constant speed. The hare also starts at the starting line but runs at a faster pace for several minutes. He then realizes that the tortoise is slow, so he stops to take a nap. When he wakes up, he sees that the tortoise has passed him, so he starts running again to the finish line.      Which animal does each function represent in the graph? Label the graph with \"Tortoise\" and \"Hare\". Explain your thinking.   A distance and time graph with a constant increasing graph starting at (0,0), and a linear graph that increases, then is constant, and ends increasing.      The graph that has a constant slope represents the tortoise because it is moving at a constant speed. The graph that increases, then is constant, and then increases again represents the hare because it starts off fast, then stops to take a nap, and then starts running again.         Tell a story about the fox's journey during the race. Include specific details about time and distance.   A distance and time graph with a constant graph starting at (9,0), a linear graph that increases, then is constant, and ends increasing, and a third graph that starts at (6,0) and is constant      The fox started the race 6 minutes after the tortoise and the hare. The fox ran at a constant speed and won the race.          Here are three statements about the race. Select all the true statements.    A. The fox's distance was always increasing.    B. Between 6 and 10 minutes, the fox was traveling faster than the other animals.    C. When the hare reached 800 meters, the fox was still at the starting line.     A distance and time graph with a constant graph starting at (9,0), a linear graph that increases, then is constant, and ends increasing, and a third graph that starts at (6,0) and is constant      B and C are true. A is false because for the first 6 minutes, the fox was not moving. B is true because the fox traveled 1600 meters in 4 minutes, while the tortoise traveled 533.33 meters in that same time and the hare traveled 300 meters in that same time. C is true because when the hare reached 800 meters, it was at 6 minutes and the fox had not started yet.      LT 1: We will now be drawing the stories     Next the tortoise raced the dog.   Draw a graph representing the relationship between distance and time for a dog that makes all of these statements true.    The dog got a head start but lost the race.    The dog and tortoise were tied at 800 meters    The dog's distance was decreasing for 3 minutes.     Time and distance graph with tortoise's steady race graphed from (0,0)      One possible graph is shown below. The dog has a 50 meter head start, ties the tortoise at 800 meters, goes backward for 3 minutes, and ends up losing the race.   Time and distance graph with tortoise's steady race graphed from (0,0). The dog is a dotted graph that starts at (0, 50) increases for 6 minutes, then decreases for 3 minutes and ends increasng but losing the race.         The graph shows what Wyatt drew to represent the dog's race.     At least one of the following statements is false Circle the false statement. Explain your thinking. Then tell Wyatt's story.    A. The dog got a head start but lost the race    B. The dog and tortoise were tied at 800 meters.    C. The dog's distance was decreasing for 3 minutes.     Time and distance graph with tortoise graphed and dog's graph starts at (2,0) and increases for a while, then is constant for several minutes, and then increases again.      The dog started 2 minutes after the tortoise. The dog was tied at 800 meters, but it did not ever decrease its distance. The dog did lose the race.          Let's take a closer look at the story of the tortoise and the hare. Refer back to the first graph of the tortoise and the hare to answer the following questions   A distance and time graph with a constant graph starting at (9,0), a linear graph that increases, then is constant, and ends increasing, and a third graph that starts at (6,0) and is constant       What is the tortoises speed?    The tortoise's speed is 133.33 meters per minute. Since his speed is constant, this is found by taking the distance (meter) and dividing by the amount of time it took to travel that distance. 1600 meters divided by 12 minutes equals 133.33 meters per minute.      What is the hare's average speed? (find all three speeds and divide by three)    The hare's average speed is 122.22 meters per minute. This is found by taking the average of the three parts of his race. At the beginning he traveled 1300 meters in 6 seconds. Dividing this distance by the time, you find his speed is 1300\/6 or 216.66 meters per minute. The second part of his race, he is resting so he has no speed or 0 meters per minute. The final part of his race, he travels 300 more meters in 2 seconds. Distance divided by time gives you 300\/2 or 150 meters per minute. Averaging the three times (216.66+0+150)\/3 gives you 122.22 meters per minute.      Who won the race? How do you know?    The tortoise won the race. I know this because the tortoise's average rate for the entire race was faster.      Now look back at the race between the tortoise, hare, and the fox. What is the fox's speed? How do you know?    The fox started the race 6 minutes in and ended he race at 10 minutes after the start; meaning he ran for a total of 4 minutes. The total distance is 1600 meters. Distance divided by time gives 1600\/4 = 400 meters per minute.      "
},
{
  "id": "activities-6-2-1",
  "level": "2",
  "url": "activities-6.html#activities-6-2-1",
  "type": "Worksheet Exercise",
  "number": "1",
  "title": "",
  "body": "  The tortoise and the hare are racing. The tortoise starts at the starting line and runs at a constant speed. The hare also starts at the starting line but runs at a faster pace for several minutes. He then realizes that the tortoise is slow, so he stops to take a nap. When he wakes up, he sees that the tortoise has passed him, so he starts running again to the finish line.      Which animal does each function represent in the graph? Label the graph with \"Tortoise\" and \"Hare\". Explain your thinking.   A distance and time graph with a constant increasing graph starting at (0,0), and a linear graph that increases, then is constant, and ends increasing.      The graph that has a constant slope represents the tortoise because it is moving at a constant speed. The graph that increases, then is constant, and then increases again represents the hare because it starts off fast, then stops to take a nap, and then starts running again.    "
},
{
  "id": "activities-6-2-2",
  "level": "2",
  "url": "activities-6.html#activities-6-2-2",
  "type": "Worksheet Exercise",
  "number": "2",
  "title": "",
...
},
{
  "id": "activities-6-3-1",
  "level": "2",
  "url": "activities-6.html#activities-6-3-1",
  "type": "Worksheet Exercise",
  "number": "3",
  "title": "",
  "body": "   Here are three statements about the race. Select all the true statements.    A. The fox's distance was always increasing.    B. Between 6 and 10 minutes, the fox was traveling faster than the other animals.    C. When the hare reached 800 meters, the fox was still at the starting line.     A distance and time graph with a constant graph starting at (9,0), a linear graph that increases, then is constant, and ends increasing, and a third graph that starts at (6,0) and is constant      B and C are true. A is false because for the first 6 minutes, the fox was not moving. B is true because the fox traveled 1600 meters in 4 minutes, while the tortoise traveled 533.33 meters in that same time and the hare traveled 300 meters in that same time. C is true because when the hare reached 800 meters, it was at 6 minutes and the fox had not started yet.   "
},
{
  "id": "activities-6-3-2",
  "level": "2",
  "url": "activities-6.html#activities-6-3-2",
  "type": "Worksheet Exercise",
  "number": "4",
  "title": "",
  "body": "  LT 1: We will now be drawing the stories     Next the tortoise raced the dog.   Draw a graph representing the relationship between distance and time for a dog that makes all of these statements true.    The dog got a head start but lost the race.    The dog and tortoise were tied at 800 meters    The dog's distance was decreasing for 3 minutes.     Time and distance graph with tortoise's steady race graphed from (0,0)      One possible graph is shown below. The dog has a 50 meter head start, ties the tortoise at 800 meters, goes backward for 3 minutes, and ends up losing the race.   Time and distance graph with tortoise's steady race graphed from (0,0). The dog is a dotted graph that starts at (0, 50) increases for 6 minutes, then decreases for 3 minutes and ends increasng but losing the race.     "
},
{
  "id": "activities-6-3-3",
  "level": "2",
  "url": "activities-6.html#activities-6-3-3",
  "type": "Worksheet Exercise",
  "number": "5",
  "title": "",
  "body": "   The graph shows what Wyatt drew to represent the dog's race.     At least one of the following statements is false Circle the false statement. Explain your thinking. Then tell Wyatt's story.    A. The dog got a head start but lost the race    B. The dog and tortoise were tied at 800 meters.    C. The dog's distance was decreasing for 3 minutes.     Time and distance graph with tortoise graphed and dog's graph starts at (2,0) and increases for a while, then is constant for several minutes, and then increases again.      The dog started 2 minutes after the tortoise. The dog was tied at 800 meters, but it did not ever decrease its distance. The dog did lose the race.    "
},
{
  "id": "activities-6-4-1",
  "level": "2",
  ...
  "number": "6",
  "title": "",
  "body": "   Let's take a closer look at the story of the tortoise and the hare. Refer back to the first graph of the tortoise and the hare to answer the following questions   A distance and time graph with a constant graph starting at (9,0), a linear graph that increases, then is constant, and ends increasing, and a third graph that starts at (6,0) and is constant       What is the tortoises speed?    The tortoise's speed is 133.33 meters per minute. Since his speed is constant, this is found by taking the distance (meter) and dividing by the amount of time it took to travel that distance. 1600 meters divided by 12 minutes equals 133.33 meters per minute.      What is the hare's average speed? (find all three speeds and divide by three)    The hare's average speed is 122.22 meters per minute. This is found by taking the average of the three parts of his race. At the beginning he traveled 1300 meters in 6 seconds. Dividing this distance by the time, you find his speed is 1300\/6 or 216.66 meters per minute. The second part of his race, he is resting so he has no speed or 0 meters per minute. The final part of his race, he travels 300 more meters in 2 seconds. Distance divided by time gives you 300\/2 or 150 meters per minute. Averaging the three times (216.66+0+150)\/3 gives you 122.22 meters per minute.      Who won the race? How do you know?    The tortoise won the race. I know this because the tortoise's average rate for the entire race was faster.      Now look back at the race between the tortoise, hare, and the fox. What is the fox's speed? How do you know?    The fox started the race 6 minutes in and ended he race at 10 minutes after the start; meaning he ran for a total of 4 minutes. The total distance is 1600 meters. Distance divided by time gives 1600\/4 = 400 meters per minute.    "
},
{
  "id": "activities-7",
  "level": "1",
  ...
  "type": "Worksheet",
  "number": "",
  "title": "Representing Linear Functions Task",
  "body": " Representing Linear Functions Task     Understanding linear functions    Being able to represent linear functions in multiple ways    Finding connections    Communicating using words, pictures, diagrams, colors, etc.    Performing basic computations   Crafting explanations   Writing and revising for clarity and precision    Planning the layout of the final product   Deciding on the important information to include (or not)   Putting strategies into words       Task:As a group, show four different ways to solve the following prompt. At least one strategy must be visual. Clearly show connections across strategies.  Ben was recently looking at the possibility of joining a gym. He called around to different gyms and the gym closest to his house had an initial membership fee of $50 and then a monthly fee of $36 per month. How many months can he keep the membership if he has $600?      Create a final product to turn in that contains:    Show each strategy that you used to solve the prompt. You can use grids, pictures, charts, words, or any other tools you need to make your explanation clear and easy to understand.    Show connections across strategies.    Include work from each person using their color.      "
},
{
  "id": "activities-7-2",
  "level": "2",
  ...
  "number": "",
  "title": "",
  "body": "   Understanding linear functions    Being able to represent linear functions in multiple ways    Finding connections    Communicating using words, pictures, diagrams, colors, etc.    Performing basic computations   Crafting explanations   Writing and revising for clarity and precision    Planning the layout of the final product   Deciding on the important information to include (or not)   Putting strategies into words    "
},
{
  "id": "activities-8",
  "level": "1",
...
},
{
  ...
  "number": "",
  "title": "",
  "body": "   Be able to create a table from a pictoral pattern    Be able to create a graph from a table of data, with labels for the independent and dependent variables.    Be able to determine the rate of change from a table and graph.    Be able to find the initial value of the pattern and write the equation that represents the pictoral pattern.    "
},
{
  "id": "activities-8-3-1",
  "level": "2",
  "url": "activities-8.html#activities-8-3-1",
  "type": "Worksheet Exercise",
  "number": "1",
  "title": "",
  "body": "  Use the following patterns. Observe the table numebers associated with the pattern.     patterns of blocks      pattern of blocks    "
},
{
  "id": "activities-8-4-1",
  "level": "2",
  "url": "activities-8.html#activities-8-4-1",
  "type": "Worksheet Exercise",
  "number": "2",
  "title": "",
  "body": "  Each table should answer the following using the indicated patterns on the next page. Each pattern lists the tables that should use that pattern. Each person at the table will be assigned a different color, and is responsible for at least one objective.     The table was filled in by:      Figure number  ___(n): number of shapes    1      2      3      4      5      10      n        "
},
{
  "id": "activities-8-4-2",
  "level": "2",
...
},
{
  "id": "activities-8-4-3",
  "level": "2",
  "url": "activities-8.html#activities-8-4-3",
  "type": "Worksheet Exercise",
  "number": "4",
  "title": "",
...
},
{
  ...
  "type": "Worksheet",
  "number": "",
  "title": "LT3 Linear Patterns- Toothpicks",
  "body": " LT3 Linear Patterns- Toothpicks     LT 3: I can recognize and identify key characteristics of a linear pattern represented in a table, graph, equation or application. I can translate between different representations.  >      Look at the pattern of toothpicks below. Recreate the pattern and determine how many toothpicks it takes to create each figure. You may add on to the previous pattern so that you do not run out of toothpicks. Continue the pattern, creating the next 3 figures. Determine the number of toothpicks it takes to create the next 3 figures and record the information in the table provided.     Step 1 is three toothpicks making a triangle. Step 2 adds two toothpicks to create another triangle to the fiture. Step 3 does the sme pattrn       Figure Number  Number of Toothpicks in Figure  Difference from Previous Figure  Number of Toothpicks in the Perimeter Distance Around  Difference from Previous Perimeter    1  3  ---  3  ---    2  5    4      3  7    5      4          5          10   ---   ---    100   ---   ---    T    ---    ---     Number of toothpicks: 9, 11, 21, 201. Number in Perimeter: 6, 7, 12, 102.      See if you can draw the 10th figure in the pattern. How many toothpicks would you need to create the 10th figure? What problem-solving strategies might you use to help you?    There are 21 toothpicks i the 10th step figure. One strategy is to realize the common difference of 2 means that it is a multiple of two. Trying out the first 5, input 1*2 you need to add 1 to get to 3; input 2*2 you again need to input 1 to get to 5... input 10*2 + 1 is 21.      Can you develop a rule that would tell you how many toothpicks would be in any figure in the pattern?    Number of Toothpicks rule: ; Perimeter rule:          Determine if the table is linear or not. Then fill out the information above the table.       x change by:   1   y changes by:  Rate of change (if it exists):  Initial Value:   42   Linear Equation (if it exists):            x  -2  -1  0  1  2  linear?    y  20  31  42  53  64  linear?       x changes by 1  y changes by 11  Rate of change:   Initial Value: 42 Equation:         x change by:  y changes by:  Rate of change (if it exists):  Initial Value:  Linear Equation (if it exists):            x  -2  -1  0  1  2  linear?    y  5  7  8  7  5  linear?       x changes by 1  y changes by Not Applicable  Rate of change: Not Applicable  Initial value: 8  Equation: Not Applicable        x change by:  y changes by:  Rate of change (if it exists):  Initial Value:  Linear Equation (if it exists):            x  -4  -2  0  2  4  linear?    y  15  9  3  -3  -9  linear?       x changes by 2  y changes by -6  Rate of change:   Initial Value: 3 Equation:       "
},
{
  "id": "activities-9-2",
  "level": "2",
  ...
  "number": "",
  "title": "",
  "body": "   LT 3: I can recognize and identify key characteristics of a linear pattern represented in a table, graph, equation or application. I can translate between different representations.  >  "
},
{
  "id": "activities-9-3-1",
  "level": "2",
  ...
  "number": "1",
  "title": "",
  "body": "  Look at the pattern of toothpicks below. Recreate the pattern and determine how many toothpicks it takes to create each figure. You may add on to the previous pattern so that you do not run out of toothpicks. Continue the pattern, creating the next 3 figures. Determine the number of toothpicks it takes to create the next 3 figures and record the information in the table provided.     Step 1 is three toothpicks making a triangle. Step 2 adds two toothpicks to create another triangle to the fiture. Step 3 does the sme pattrn       Figure Number  Number of Toothpicks in Figure  Difference from Previous Figure  Number of Toothpicks in the Perimeter Distance Around  Difference from Previous Perimeter    1  3  ---  3  ---    2  5    4      3  7    5      4          5          10   ---   ---    100   ---   ---    T    ---    ---     Number of toothpicks: 9, 11, 21, 201. Number in Perimeter: 6, 7, 12, 102.      See if you can draw the 10th figure in the pattern. How many toothpicks would you need to create the 10th figure? What problem-solving strategies might you use to help you?    There are 21 toothpicks i the 10th step figure. One strategy is to realize the common difference of 2 means that it is a multiple of two. Trying out the first 5, input 1*2 you need to add 1 to get to 3; input 2*2 you again need to input 1 to get to 5... input 10*2 + 1 is 21.      Can you develop a rule that would tell you how many toothpicks would be in any figure in the pattern?    Number of Toothpicks rule: ; Perimeter rule:     "
},
{
  "id": "activities-9-4-1",
  "level": "2",
  ...
  "number": "2",
  "title": "",
  "body": "  Determine if the table is linear or not. Then fill out the information above the table.       x change by:   1   y changes by:  Rate of change (if it exists):  Initial Value:   42   Linear Equation (if it exists):            x  -2  -1  0  1  2  linear?    y  20  31  42  53  64  linear?       x changes by 1  y changes by 11  Rate of change:   Initial Value: 42 Equation:         x change by:  y changes by:  Rate of change (if it exists):  Initial Value:  Linear Equation (if it exists):            x  -2  -1  0  1  2  linear?    y  5  7  8  7  5  linear?       x changes by 1  y changes by Not Applicable  Rate of change: Not Applicable  Initial value: 8  Equation: Not Applicable        x change by:  y changes by:  Rate of change (if it exists):  Initial Value:  Linear Equation (if it exists):            x  -4  -2  0  2  4  linear?    y  15  9  3  -3  -9  linear?       x changes by 2  y changes by -6  Rate of change:   Initial Value: 3 Equation:     "
},
{
  "id": "ws-a",
  "level": "1",
  ...
  "type": "Worksheet",
  "number": "",
  "title": "LT 4 Linear Graphs",
  "body": " LT 4 Linear Graphs    Identify the slope.  Identify the intercepts.  Evaluate and find when given .  Make the equation of the line.       Slope is the measure of the steepness and direction of a line. It is calculated as the ratio of the vertical change (\"rise\") to the horizontal change (\"run\") between any two distinct points on a line.      An intercept is the point where a line or curve crosses or intersects an axis on a coordinate plane.     Graph of f of x equals x minus 2 on coordinate axes ranging from -4 to 5.    f(x) = x - 2           Finding Slope     How will you find the vertical change and the horizontal change?    For the vertical change, find the difference of the y values. The vertical change goes up 2 from the left most graph. For the horizontal change, find the difference of the x values. The horizontal change is 2 across from the vertical change.      Find the slope of the line between the two points labeled on the graph. Be sure to show your work.    Using points and from the graph:  The slope of the line is .        Intercepts of Linear Graphs   In general terms, what is the correct ordered pair for the y-intercept, or ? Explain your reasoning.    The correct ordered pair is . The x-value is because to graph a y-intercept you start at the origin and do not move left or right, so , then move up or down to the point .      Finding Intercepts     What is the y-intercept of the graph?    The point that intersects the y-axis, or the y-intercept, is .      What is the x-intercept of the graph?    The point that intersects the x-axis, or the x-intercept, is .         Function notation is a way to write a function using symbols that show the relationship between an input and an output. Notation:    — the name of the function.  — the input of the function (also called the independent variable).  — the output when is applied to the function.        Using Function Notation on the Graph of .     Explain how you would use the graph to find .    Go to on the x-axis since we know that . Go up or down from there until you reach the line. The y-value at that point is your answer.      Use the graph to find .    The point where is . This tells us .      Explain how you would use the graph to find when .    Go to on the y-axis since we know that . Go left or right from there until you reach the line. The x-value at that point is your answer.      Use the graph to find when .    The point where is . This tells us when .      "
},
{
  "id": "ws-a-2",
  "level": "2",
  "url": "ws-a.html#ws-a-2",
  "type": "Objectives",
  "number": "",
  "title": "",
  "body": "  Identify the slope.  Identify the intercepts.  Evaluate and find when given .  Make the equation of the line.   "
},
{
  "id": "def-x1",
  "level": "2",
...
},
{
  "id": "ws-a-3-4",
  "level": "2",
  "url": "ws-a.html#ws-a-3-4",
  "type": "Worksheet Exercise",
  "number": "1",
  "title": "",
  "body": "  Finding Slope     How will you find the vertical change and the horizontal change?    For the vertical change, find the difference of the y values. The vertical change goes up 2 from the left most graph. For the horizontal change, find the difference of the x values. The horizontal change is 2 across from the vertical change.      Find the slope of the line between the two points labeled on the graph. Be sure to show your work.    Using points and from the graph:  The slope of the line is .    "
},
{
  "id": "ex-mc",
  "level": "2",
  ...
  "type": "Worksheet Exercise",
  "number": "2",
  "title": "Intercepts of Linear Graphs.",
  "body": " Intercepts of Linear Graphs   In general terms, what is the correct ordered pair for the y-intercept, or ? Explain your reasoning.    The correct ordered pair is . The x-value is because to graph a y-intercept you start at the origin and do not move left or right, so , then move up or down to the point .   "
},
{
  "id": "ws-a-4-2",
  "level": "2",
  "url": "ws-a.html#ws-a-4-2",
  "type": "Worksheet Exercise",
  "number": "3",
  "title": "",
  "body": "  Finding Intercepts     What is the y-intercept of the graph?    The point that intersects the y-axis, or the y-intercept, is .      What is the x-intercept of the graph?    The point that intersects the x-axis, or the x-intercept, is .    "
},
{
  "id": "def-a",
  "level": "2",
...
},
{
  ...
  "body": " LT3-4:Linear Patterns and Equations  Beginning Algebra Made Useful by Char E. Beckman     What do you know about linear equations? Give brief answers now and think about these questions as you work on the problems below.    What patterns would you see in a table of data that can be modeled by a linear equation?    What patterns would you see in a graph of data that can be modeled by a linear equation?    What would an equation of a linear equation look like?      Look at the three data sets below. Label each set of data as linear or non-linear. Explain your choice.         x  y    -5  -14    -4  -12    -3  -10    -2  -8    -1  -6    0  -4    1  -2    2  0    3  2    4  4    5  6              x  y    -5  0.03125    -4  0.0625    -3  0.125    -2  0..25    -1  0.5    0  1    1  2    2  4    3  8    4  16    5  32              x  y    -5  25    -4  16    -3  9    -2  4    -1  1    0  0    1  1    2  4    3  9    4  16    5  25            The first table is the only linear data set. The x's all increase by 1 and the y's all increase by 2         Three stories are provided. Gather data for each one. Label each set of data as linear or non-linear. Explain your choice. Do not worry about finding the equation for the non-linear     width=20% halign=\"center\"  width=20%   Geppetto carved Pinocchio a 2-inch-long nose. Each time Pinocchio tells a lie, his nose grows 3 inches. How long will his nose be after 1 lie? 2 lies? 3 lies? L lies?  Geppetto carved Pinocchio a 2-inch-long nose. Each time Pinocchio tells a lie, his nose doubles in length. How long will his nose be after 1 lie? 2 lies? 3 lies? L lies?  Geppetto carved Pinocchio a 2-inch-long nose. Each time Pinocchio tells a lie, his nose grows from its previous length by the same number of inches as the number of lies he has told. For example, after 1 lie, his nose will be 2 + 1 = 3 inches long. After 2 lies, his nose will be 3 + 2 = 5 inches long. How long will his nose be after 3 lies? 4 lies? 5 lies? L lies?    No. Lines  Nose Length  No. Lies  Nose Length  No. Lies  Nose Length    0  2  0  2  0  2    1    1    1  2+1=3    2    2    2  3+2=5    3    3    3      4    4    4      5    5    5      L    L    L       The first story is the only linear story. It describes adding three inches for each lie. This is a constant increase or common difference,       Categorize each graph as linear or non-linear.     width=20% halign=\"center\"  width=20%   Graph A  Graph B  Graph C    increasing line graph   decreasing curve above the x-axis   parabola opens up                 The first graph is the only linear graph. We know this because it is the only graph that is a straight line.         Categorize each equation as linear or non-linear.     width=20% halign=\"center\"  width=20%   Equation 1  Equation 2  Equation 3                     The first equation is linear. It does not have an exponent. It is in the form y = mx + b.       Revisit problem 1. What can you add to your previous answers? Use the back of this page as needed.     What patterns would you see in a table of data that can be modeled by a linear equation? Can you find the equation of the linear data?    Linear data has a common difference. The equation is       How can you tell a graph can be modeled by a linear equation? CAn you find the equation of the linear graph?    Linear graphs are straight lines. The equation is       What would an equation of a linear equation look like?    Linear equations are in the form of       How can you tell if a story is likely to be modeled by a linear equation? Can you find the equation of the linear story?    A story uses words that infer addition or subtraction. The equation is       "
},
{
  ...
  "number": "1",
  "title": "",
  "body": "  What do you know about linear equations? Give brief answers now and think about these questions as you work on the problems below.    What patterns would you see in a table of data that can be modeled by a linear equation?    What patterns would you see in a graph of data that can be modeled by a linear equation?    What would an equation of a linear equation look like?   "
},
{
  "id": "activities-11-3-2",
  "level": "2",
  "url": "activities-11.html#activities-11-3-2",
  "type": "Worksheet Exercise",
  "number": "2",
  "title": "",
  "body": "  Look at the three data sets below. Label each set of data as linear or non-linear. Explain your choice.         x  y    -5  -14    -4  -12    -3  -10    -2  -8    -1  -6    0  -4    1  -2    2  0    3  2    4  4    5  6              x  y    -5  0.03125    -4  0.0625    -3  0.125    -2  0..25    -1  0.5    0  1    1  2    2  4    3  8    4  16    5  32              x  y    -5  25    -4  16    -3  9    -2  4    -1  1    0  0    1  1    2  4    3  9    4  16    5  25            The first table is the only linear data set. The x's all increase by 1 and the y's all increase by 2    "
},
{
  ...
  "number": "3",
  "title": "",
  "body": "  Three stories are provided. Gather data for each one. Label each set of data as linear or non-linear. Explain your choice. Do not worry about finding the equation for the non-linear     width=20% halign=\"center\"  width=20%   Geppetto carved Pinocchio a 2-inch-long nose. Each time Pinocchio tells a lie, his nose grows 3 inches. How long will his nose be after 1 lie? 2 lies? 3 lies? L lies?  Geppetto carved Pinocchio a 2-inch-long nose. Each time Pinocchio tells a lie, his nose doubles in length. How long will his nose be after 1 lie? 2 lies? 3 lies? L lies?  Geppetto carved Pinocchio a 2-inch-long nose. Each time Pinocchio tells a lie, his nose grows from its previous length by the same number of inches as the number of lies he has told. For example, after 1 lie, his nose will be 2 + 1 = 3 inches long. After 2 lies, his nose will be 3 + 2 = 5 inches long. How long will his nose be after 3 lies? 4 lies? 5 lies? L lies?    No. Lines  Nose Length  No. Lies  Nose Length  No. Lies  Nose Length    0  2  0  2  0  2    1    1    1  2+1=3    2    2    2  3+2=5    3    3    3      4    4    4      5    5    5      L    L    L       The first story is the only linear story. It describes adding three inches for each lie. This is a constant increase or common difference,    "
},
{
  "id": "activities-11-4-2",
  "level": "2",
  "url": "activities-11.html#activities-11-4-2",
  "type": "Worksheet Exercise",
  "number": "4",
  "title": "",
  "body": "  Categorize each graph as linear or non-linear.     width=20% halign=\"center\"  width=20%   Graph A  Graph B  Graph C    increasing line graph   decreasing curve above the x-axis   parabola opens up                 The first graph is the only linear graph. We know this because it is the only graph that is a straight line.    "
},
{
  ...
  "number": "5",
  "title": "",
  "body": "  Categorize each equation as linear or non-linear.     width=20% halign=\"center\"  width=20%   Equation 1  Equation 2  Equation 3                     The first equation is linear. It does not have an exponent. It is in the form y = mx + b.    "
},
{
  "id": "activities-11-5-2",
  "level": "2",
  "url": "activities-11.html#activities-11-5-2",
  "type": "Worksheet Exercise",
  "number": "6",
  "title": "",
...
{
  "id": "activities-12-3-2",
  "level": "2",
  "url": "activities-12.html#activities-12-3-2",
  "type": "Worksheet Exercise",
  "number": "1",
  "title": "",
...
{
  "id": "activities-12-3-3",
  "level": "2",
  "url": "activities-12.html#activities-12-3-3",
  "type": "Worksheet Exercise",
  "number": "2",
  "title": "",
...
{
  "id": "activities-12-3-4",
  "level": "2",
  "url": "activities-12.html#activities-12-3-4",
  "type": "Worksheet Exercise",
  "number": "3",
  "title": "",
  "body": "  Which of the tables have linear data? Explain your reasoning.    The table has inputs that are all increasing by adding , and the outputs are all increasing by adding . This constant addition makes the data linear. The table has inputs that all increase by adding and the outputs are all decreasing by subtracting . This constant addition\/subtraction makes the data linear. The table has inputs that increase by adding and outputs that increase by adding . Since both the inputs and outputs consistently are chaning the the same amounts, the data is linear.   "
...
{
  "id": "activities-12-3-5",
  "level": "2",
  "url": "activities-12.html#activities-12-3-5",
  "type": "Worksheet Exercise",
  "number": "4",
  "title": "",
...
{
  "id": "activities-12-3-6",
  "level": "2",
  "url": "activities-12.html#activities-12-3-6",
  "type": "Worksheet Exercise",
  "number": "5",
  "title": "",
...
{
  "id": "activities-12-3-7",
  "level": "2",
  "url": "activities-12.html#activities-12-3-7",
  "type": "Worksheet Exercise",
  "number": "6",
  "title": "",
...
{
  "id": "activities-12-4-2",
  "level": "2",
  "url": "activities-12.html#activities-12-4-2",
  "type": "Worksheet Exercise",
  "number": "7",
  "title": "",
  "body": "  Find the equation of the graphed line. Show all of your work.    First find the y-intercept.This tells us the of the equation. Next find the slope by using rise over run. Start with a point on the left. Go up (positive rise) or down(negative rise) to get across from the next point you want to use. Then go left (negative run) or right (positive run) until you are on the line. The fraction rise\/run is the of the equation.  Using the y-intercept and the point (1,1): The y-intercept is (0,2), so we know that . To find the slope, use rise over run. Start with a point on the left which is the y-intercept in this case. Go down(negative rise) to get across from the next point you want to use. We go down 1, so our rise is -1. Then go right (positive run) until you are on the line. We go to the right 1, so our run is +1. Rise\/run =    "
},
{
  "id": "activities-12-4-3",
  "level": "2",
  "url": "activities-12.html#activities-12-4-3",
  "type": "Worksheet Exercise",
  "number": "8",
  "title": "",
...
{
  "id": "activities-12-4-4",
  "level": "2",
  "url": "activities-12.html#activities-12-4-4",
  "type": "Worksheet Exercise",
  "number": "9",
  "title": "",
  "body": "  Find the equation of the line in slope-intercept form: . The line has a slope of and contains the point .    We are given , , . The equation is: .   "
},
{
  "id": "activities-12-4-5",
  "level": "2",
  "url": "activities-12.html#activities-12-4-5",
  "type": "Worksheet Exercise",
  "number": "10",
  "title": "",
...
{
  "id": "activities-12-4-6",
  "level": "2",
  "url": "activities-12.html#activities-12-4-6",
  "type": "Worksheet Exercise",
  "number": "11",
  "title": "",
...
{
  "id": "activities-12-5-1",
  "level": "2",
  "url": "activities-12.html#activities-12-5-1",
  "type": "Worksheet Exercise",
  "number": "12",
  "title": "",
  "body": "  Answer the questions about the parameters of the equation; always comparing to the parent function equation      Given , without graphing, explain how this line differs from the parent function.    Because of the -2, we know this line is decreasing instead of increasing, and it is steeper than the parent function. The +4 tells us that all points on this graph move up 4 units.      Given and , without graphing:    Which line is flatter? Explain how your know from the equations    Which line has the smallest y-intercept? What is it?      The graph would have the flatter line because its slope of 0.5 is smaller than the slope of , which is 2.  The graph has the smaller y-intercept which is (0, 0). The y=-intercept of is (0,2)      Write the equation of the line that has a very steep, negative slope and a y-intercept that is below the x-axis.  Explain your thinking. Then draw your graph by hand - without using a graphing technology.    Answer will vary. One example is . The slope is -5 because the farther away from 0 in the left direction, the steeper the line. The y-intercept (the ) needs to be any negative number.  Put your equation into a graphing technology to check for accuracy.    "
},
{
  "id": "activities-13",
  "level": "1",
  ...
  "body": " LT 4 Linear Characteristics    For each representation below:   Find or indicate the vertical intercept.    Find or indicate the slope.    Explain the behavior of the line and your reasoning for your answer.    Find the equation of the line represented.            Representation  Vertical Intercept  Slope  Behavior (Incr\/Decr\/Vertical\/Horz)  Equation    1.        ----    2. (2,3), (10, -1)             3. (-5,-4), (2, -4)             4. A line contains the point (2,6) and is parallel to the line .          5.   f(x)=-0.75*x+1.5                6.  Linear graph with negative slope                1. (0,-2); ; Increasing.  2. (0, 4);    "
},
{
  "id": "activities-13-2",
  "level": "2",
...
},
{
  ...
  "body": " LT 4 Slope and Y-intercept Discovery  Go to Desmos and type in the equations and . Click on \"all\" sliders.    Let . Move the slider, make observations, and answer the following questions.     What do you notice when     The y-intercept is above the x-axis, and all the points move up b-units.      What do you notice when ?    The y-intercept is at the origin (0,0).      What do you notice when is less than 0?    The y-intercept is below the x-axis, and all the points move down b-units.       Let . Move the slider, make observations, and answer the following questions.     What do you notice when     The line goes up from left to right; it increases. The bigger the value for , the steeper the line.      What do you notice when ?    The line is horizontal.      What do you notice when is less than 0?    The line goes down from left to right; it decreases. The smaller the value is, the steeper the line becomes.      What do you notice when the slope is close to zero on the right side?.....left side?    When slope is very close to zero, on either side, the line is very flat. This is because the when the , the line is horizontal. If the slope is not much bigger than 0, the line will not be much steeper than horizontal.      What do you notice when the slope is farther from zero on the right side (very large)...the left side (very small)?    The farther the slope gets from zero, the steeper the line gets. The line is getting further away from being horizontal.       Consider the next several questions. Each equation contains a three (3). Discuss with your group ho the 3 of the equation will affect the graph of . Do not graph before making your decision.        The slope changes from 1 to 3 so the line is steeper. The output values will be 3 times what they were before. The x and y intercepts stay the same (0,0).  The slope is the same; all output values are three less than they were on the line y = x. The graph will be 3 units down and parallel to the graph of y=x. [i.e. (0,0) becomes (0, -3)]  The slope is the same; all output values are three more than they were on the line y = x. The graph will be 3 units up and parallel to the graph of y=x. [i.e. (0,0) becomes (0, 3)]    The slope is the same; all output values are three more than they were on the line y = x. The graph will be 3 units up and parallel to the graph of y=x. [i.e. (0,0) becomes (0, 3)]         The slope changes from 1 to 3 so the line is steeper. The output values will be 3 times what they were before. The x and y intercepts stay the same (0,0).  The slope is the same; all output values are three less than they were on the line y = x. The graph will be 3 units down and parallel to the graph of y=x. [i.e. (0,0) becomes (0, -3)]  The slope is the same; all output values are three more than they were on the line y = x. The graph will be 3 units up and parallel to the graph of y=x. [i.e. (0,0) becomes (0, 3)]    The slope is the same; all output values are three less than they were on the line y = x. The graph will be 3 units down and parallel to the graph of y=x. [i.e. (0,0) becomes (0, -3)]         The slope changes from 1 to 3 so the line is steeper. The output values will be 3 times what they were before. The x and y intercepts stay the same (0,0).  The slope is the same; all output values are three less than they were on the line y = x. The graph will be 3 units down and parallel to the graph of y=x. [i.e. (0,0) becomes (0, -3)]  The slope is the same; all output values are three more than they were on the line y = x. The graph will be 3 units up and parallel to the graph of y=x. [i.e. (0,0) becomes (0, 3)]    The slope changes from 1 to 3 so the line is steeper. The output values will be 3 times what they were before. The x and y intercepts stay the same (0,0).     "
},
{
  "id": "activities-14-3",
  "level": "2",
...
},
{
  ...
  "type": "Worksheet",
  "number": "",
  "title": "LT 5 Meaning of Slope and Y-Intercept",
  "body": " LT 5 Meaning of Slope and Y-Intercept     Fill in the table:        Story  Slope and its meaning  Y-intercept and its Meaning    1. Farmer Ali had a well on his property 200 feet deep. When the well went dry, he hired a company to drill the well deeper. He used the equation to find the depth of the well, , using the number of days the company drilled, .         2. Kristina is running the freshman class fundraiser. They are selling key chains. The amount of money they will make is computed using the function , where represents the number of key chains sold, and represents the amount of money made         3. Jose, the electrician, charges $65 per hour to fix your electrical box issues. He uses the equation to determine the change after working hours.         4. It costs Corporal Motors $500,000 to outfit their new car line. The company used the equation to detrmine the amount of profit earned from the sale of cars.         5. Liz has been paying her credit card bill since January 1st, 2026. The eqquation represents the relationship between the number of months that she has been paying, and the amount on her credit card bill .         6. Abby lights a candle in her kitchen, The height of the candle is represented y the equation , where is the time in hours the candle has been burning, and is the height of the candle in inches.          1. The well goes 75 feet deeper per day ; The well was 200 feet deep before drilling began.  2. Each keychain sold increases the amount of money earned by $2.; The freshman class had $100 in expenses before selling began.  3. Jose charges $65 per hour.; Jose charges $100 fee to come out.  4. The profit goes up $2500 per car sold.; The company incurred $500,000 costs before selling the cars.  5. Liz pays down the debt by $100 per month.; The original amount of the bill was $675.  6. The candle height goes down 0.5 inches per hour.; The original height of the candle was 6 inches.        Each story below will either ask for a calculation to be done or an equation to be found. Do what is asked, and leave the other column blank.        Story  Calculation  Equation    Maui begins working at Macy's. She will be paid a daily amount plus a commission of her total sales. The equation represents the amount Maui will make based on her total sales where is the amount of money she makes in one day, and is her total sales. How much will Maui make if she sells $650?    ---    Alejandra paints faces at kids' parties to earn extra money. The equation represents the relationship between the money she makes after painting faces. Alejandra wants to buy a new pair of Uggs that cost $119.50. How many faces does she need to paint in order to pay for her Uggs?    ---    Archie is learning to scuba dive. The equation represents the depth, he can dive, in feet, based on the number of lessons, he has taken. How deep can Archie dive after he has taken 13 lessons?    ---    Stormy joins a gym. She pays $15 for the membership and $6 for each session she does at the gym. Write and equation that models the relationship between the cost that STormy pays, and the number of sessions that she does at the gym. Write the equation in function notation.  ---      Michael is draining his pool for the winter, There are 3200 gallons of water in the pool and it is decreasing at a rate of 200 gallons per hour. Write an equation to represent the relationship between the amount of water in the pool, and the number of hours the poos has been draining. Write the equation in function notation.  ---      Mama B is planning Thanksgiving dinner. The number of pounds of turkey she will buy depends on the number of people she invites to dinner. If she invites 12 people, she needs to buy a 15 pound turkey. If she invites 20 people, she needs to buy a 25 pound turkey. Write an equation to represent the relationship between the number of guests and the pounds of turkey needed. Write the equation in function notation.  ---       1. Maui will make $80 if she has $650 in sales.  2. ; Alejandra need to paint 43 faces to make enough money to buy the Uggs.  3. If Archie takes 14 lessons, he can dive 275 feet.  4.   5.   6. Hint: Make two points [(number of people, pounds of turkey)] to find slope and then find the y-intercept (b).      Wyatt joins a streaming service. She pays $15 to set up the service and $4.99 per month to use the service.     If is the cost of the service, and is the number of months using the service, find and explain what it means in the context of the problem.       If Wyatt uses the streaming service for 6 months, her cost will be $44.94.      What do the domain values represent?    The number of months using the service      What is the practical domain; answer in interval or inequality notation? (does infinity makes sense?)    Answers vary. One possible answer: or       What is the practical range; answer in interval or inequality notation? (How does the domain factor into finding the range?)    Answers vary. One possible answer to go with the previous domain: and . So the range is or       "
},
{
  "id": "activities-15-2-1",
  "level": "2",
  "url": "activities-15.html#activities-15-2-1",
  "type": "Worksheet Exercise",
  "number": "1",
  "title": "",
  "body": "  Fill in the table:        Story  Slope and its meaning  Y-intercept and its Meaning    1. Farmer Ali had a well on his property 200 feet deep. When the well went dry, he hired a company to drill the well deeper. He used the equation to find the depth of the well, , using the number of days the company drilled, .         2. Kristina is running the freshman class fundraiser. They are selling key chains. The amount of money they will make is computed using the function , where represents the number of key chains sold, and represents the amount of money made         3. Jose, the electrician, charges $65 per hour to fix your electrical box issues. He uses the equation to determine the change after working hours.         4. It costs Corporal Motors $500,000 to outfit their new car line. The company used the equation to detrmine the amount of profit earned from the sale of cars.         5. Liz has been paying her credit card bill since January 1st, 2026. The eqquation represents the relationship between the number of months that she has been paying, and the amount on her credit card bill .         6. Abby lights a candle in her kitchen, The height of the candle is represented y the equation , where is the time in hours the candle has been burning, and is the height of the candle in inches.          1. The well goes 75 feet deeper per day ; The well was 200 feet deep before drilling began.  2. Each keychain sold increases the amount of money earned by $2.; The freshman class had $100 in expenses before selling began.  3. Jose charges $65 per hour.; Jose charges $100 fee to come out.  4. The profit goes up $2500 per car sold.; The company incurred $500,000 costs before selling the cars.  5. Liz pays down the debt by $100 per month.; The original amount of the bill was $675.  6. The candle height goes down 0.5 inches per hour.; The original height of the candle was 6 inches.   "
},
{
  "id": "activities-15-3-1",
  "level": "2",
  "url": "activities-15.html#activities-15-3-1",
  "type": "Worksheet Exercise",
  "number": "2",
  "title": "",
  "body": "  Each story below will either ask for a calculation to be done or an equation to be found. Do what is asked, and leave the other column blank.        Story  Calculation  Equation    Maui begins working at Macy's. She will be paid a daily amount plus a commission of her total sales. The equation represents the amount Maui will make based on her total sales where is the amount of money she makes in one day, and is her total sales. How much will Maui make if she sells $650?    ---    Alejandra paints faces at kids' parties to earn extra money. The equation represents the relationship between the money she makes after painting faces. Alejandra wants to buy a new pair of Uggs that cost $119.50. How many faces does she need to paint in order to pay for her Uggs?    ---    Archie is learning to scuba dive. The equation represents the depth, he can dive, in feet, based on the number of lessons, he has taken. How deep can Archie dive after he has taken 13 lessons?    ---    Stormy joins a gym. She pays $15 for the membership and $6 for each session she does at the gym. Write and equation that models the relationship between the cost that STormy pays, and the number of sessions that she does at the gym. Write the equation in function notation.  ---      Michael is draining his pool for the winter, There are 3200 gallons of water in the pool and it is decreasing at a rate of 200 gallons per hour. Write an equation to represent the relationship between the amount of water in the pool, and the number of hours the poos has been draining. Write the equation in function notation.  ---      Mama B is planning Thanksgiving dinner. The number of pounds of turkey she will buy depends on the number of people she invites to dinner. If she invites 12 people, she needs to buy a 15 pound turkey. If she invites 20 people, she needs to buy a 25 pound turkey. Write an equation to represent the relationship between the number of guests and the pounds of turkey needed. Write the equation in function notation.  ---       1. Maui will make $80 if she has $650 in sales.  2. ; Alejandra need to paint 43 faces to make enough money to buy the Uggs.  3. If Archie takes 14 lessons, he can dive 275 feet.  4.   5.   6. Hint: Make two points [(number of people, pounds of turkey)] to find slope and then find the y-intercept (b).   "
},
{
...
},
{
  ...
  "type": "Worksheet",
  "number": "",
  "title": "LT 5 Linear Workout Task",
  "body": " LT 5 Linear Workout Task     Jada burns 215 calories during her 30-minute morning jog. In comparison, Ahmed burns 278 calories jogging with her. Your job is to choose an activity for either Jada or Ahmed to do during the day, then follow these steps to find an equation and its relationship to the table and graph. As a group you will be making a final product documenting your work.         Activity Minutes  Total Calories Burned (include the calories burned jogging)    0     1     2     20     30     45     60       Even number tables will use Jada's information. Odd number tables will use Ahmed's information.    Fill in the table:    How many total calories hae they burned during 1 minute of the chosen activity?     >  As a group, discuss what expression (not equation) will find the total calories burned after 20 minutes of doing the chosen activity. Check that your expression gives you the result you found in the table. Let the minutes be , and the total number of calories be       Write out the expression for .      What is the rate of your expression? What does it mean in the context of the story?      WRite an equation for relating the time to the total calories burned. Check that your equation produces the value you found in your table.      Approximately how many minutes of the activity are needed to burn 440 calories? Round to the nearest whole. Show your work.        Go to Desmos, plot the points from your table (use the + at the top left corner and choose table). In the line below your table, write your equation. Graph the equation on graph paper (ask your teacher). Do not forget to label your axes. Do not use x and y.     How does the starting value (0 minutes) show up in the equation you found?      What does it mean in the context of the story?      How does it show up in your graph?       Without using technology, describe how doubling the number of calories burned per minute will change the graph. Round sketch this on your graph in a different color       Read through this in its entirety before starting your final product.     Each group member must contribute to the final product. Use different colors to indicate different people's work.    Be sure to put your table number at the top of your paper.    List the person (Jada or Ahmed) and activity your group is working on.    WRite your equation near the top of your paper.    Copy your table and graph with word labels on the axes to your paper.    Show your work finding the number of minutes to burn 440 calories.    Label the starting point on your graph with an ordered pair and explain its contextual meaning next to it.    Add how you found your rate of change, and its contextual meaning.    Finally, sketch the graph for the double calories burned.           Activity  Jada Calories Burned in 30 min.  Ahmed Calories Burned in 30 min    Clean Windows  101  131    Spinning(Moderate Rate)  116  150    Walking (3mph)  134  173    Mowing the Lawn (Push)  134  173    Calisthenics  138  178    Ashtanga yoga  158  205    Clean gutters  162  210    Zumba  243  315    Cross fit  336  359    Jump rope  306  399    Cycling (14,16mph)  324  420    Running (10mph)  551  714     "
},
{
  "id": "activities-16-2-1",
  "level": "2",
  "url": "activities-16.html#activities-16-2-1",
  "type": "Worksheet Exercise",
  "number": "1",
  "title": "",
  "body": "  Jada burns 215 calories during her 30-minute morning jog. In comparison, Ahmed burns 278 calories jogging with her. Your job is to choose an activity for either Jada or Ahmed to do during the day, then follow these steps to find an equation and its relationship to the table and graph. As a group you will be making a final product documenting your work.         Activity Minutes  Total Calories Burned (include the calories burned jogging)    0     1     2     20     30     45     60       Even number tables will use Jada's information. Odd number tables will use Ahmed's information.    Fill in the table:    How many total calories hae they burned during 1 minute of the chosen activity?    "
},
{
  "id": "activities-16-2-2",
  "level": "2",
  "url": "activities-16.html#activities-16-2-2",
  "type": "Worksheet Exercise",
  "number": "2",
  "title": "",
  "body": ">  As a group, discuss what expression (not equation) will find the total calories burned after 20 minutes of doing the chosen activity. Check that your expression gives you the result you found in the table. Let the minutes be , and the total number of calories be    "
},
{
  "id": "activities-16-2-3",
  "level": "2",
  "url": "activities-16.html#activities-16-2-3",
  "type": "Worksheet Exercise",
  "number": "3",
  "title": "",
  "body": "  Write out the expression for .   "
},
{
  "id": "activities-16-2-4",
  "level": "2",
  "url": "activities-16.html#activities-16-2-4",
  "type": "Worksheet Exercise",
  "number": "4",
  "title": "",
  "body": "  What is the rate of your expression? What does it mean in the context of the story?   "
},
{
  "id": "activities-16-2-5",
  "level": "2",
  "url": "activities-16.html#activities-16-2-5",
  "type": "Worksheet Exercise",
  "number": "5",
  "title": "",
  "body": "  WRite an equation for relating the time to the total calories burned. Check that your equation produces the value you found in your table.   "
},
{
  "id": "activities-16-2-6",
  "level": "2",
  "url": "activities-16.html#activities-16-2-6",
  "type": "Worksheet Exercise",
  "number": "6",
  "title": "",
  "body": "  Approximately how many minutes of the activity are needed to burn 440 calories? Round to the nearest whole. Show your work.   "
},
{
  "id": "activities-16-3-1",
  "level": "2",
  "url": "activities-16.html#activities-16-3-1",
  "type": "Worksheet Exercise",
  "number": "7",
  "title": "",
  "body": "  Go to Desmos, plot the points from your table (use the + at the top left corner and choose table). In the line below your table, write your equation. Graph the equation on graph paper (ask your teacher). Do not forget to label your axes. Do not use x and y.     How does the starting value (0 minutes) show up in the equation you found?      What does it mean in the context of the story?      How does it show up in your graph?    "
},
{
  "id": "activities-16-3-2",
  "level": "2",
  "url": "activities-16.html#activities-16-3-2",
  "type": "Worksheet Exercise",
  "number": "8",
  "title": "",
  "body": "  Without using technology, describe how doubling the number of calories burned per minute will change the graph. Round sketch this on your graph in a different color   "
},
{
  "id": "activities-17",
  "level": "1",
...
},
{
  "id": "activities-17-2",
  "level": "2",
  "url": "activities-17.html#activities-17-2",
  "type": "Objectives",
  "number": "",
  "title": "",
...
{
  "id": "activities-17-3-2",
  "level": "2",
  "url": "activities-17.html#activities-17-3-2",
  "type": "Worksheet Exercise",
  "number": "1",
  "title": "",
...
{
  "id": "activities-17-3-3",
  "level": "2",
  "url": "activities-17.html#activities-17-3-3",
  "type": "Worksheet Exercise",
  "number": "2",
  "title": "",
...
{
  "id": "activities-17-4-2",
  "level": "2",
  "url": "activities-17.html#activities-17-4-2",
  "type": "Worksheet Exercise",
  "number": "4",
  "title": "",
...
{
  "id": "activities-17-4-3",
  "level": "2",
  "url": "activities-17.html#activities-17-4-3",
  "type": "Worksheet Exercise",
  "number": "5",
  "title": "",
...
{
  "id": "activities-17-5-2",
  "level": "2",
  "url": "activities-17.html#activities-17-5-2",
  "type": "Worksheet Exercise",
  "number": "7",
  "title": "",
...
{
  "id": "activities-17-5-3",
  "level": "2",
  "url": "activities-17.html#activities-17-5-3",
  "type": "Worksheet Exercise",
  "number": "8",
  "title": "",
...
},
{
  "id": "activities-18-10",
  "level": "2",
  "url": "activities-18.html#activities-18-10",
  "type": "Worksheet Exercise",
  "number": "7",
  "title": "Plan B.",
...
},
{
  "id": "activities-18-11",
  "level": "2",
  "url": "activities-18.html#activities-18-11",
  "type": "Worksheet Exercise",
  "number": "8",
  "title": "",
...
},
{
  "id": "activities-18-12",
  "level": "2",
  "url": "activities-18.html#activities-18-12",
  "type": "Worksheet Exercise",
  "number": "9",
  "title": "",
...
{
  "id": "activities-19-2-3",
  "level": "2",
  "url": "activities-19.html#activities-19-2-3",
  "type": "Worksheet Exercise",
  "number": "2",
  "title": "",
...
{
  "id": "activities-19-2-4",
  "level": "2",
  "url": "activities-19.html#activities-19-2-4",
  "type": "Worksheet Exercise",
  "number": "3",
  "title": "",
...
{
  "id": "activities-19-3-2",
  "level": "2",
  "url": "activities-19.html#activities-19-3-2",
  "type": "Worksheet Exercise",
  "number": "5",
  "title": "",
  "body": "  Use your model to predict from what height the ball needs to be dropped for it to bounce 30 inches. Write a sentence to summarize your answer. Test your prediction!   "
},
{
  "id": "activities-19-3-3",
  "level": "2",
  "url": "activities-19.html#activities-19-3-3",
  "type": "Worksheet Exercise",
  "number": "6",
  "title": "",
  "body": "  Find B(10) and summarize your solution with a sentence that uses the context of this problem.   "
},
{
  "id": "activities-19-3-4",
  "level": "2",
  "url": "activities-19.html#activities-19-3-4",
  "type": "Worksheet Exercise",
  "number": "7",
  "title": "",
  "body": "  Find D so that B(d) = 20 and summarize your solution with a sentence that uses the context of this problem.   "
},
{
  "id": "activities-19-3-5",
  "level": "2",
  "url": "activities-19.html#activities-19-3-5",
  "type": "Worksheet Exercise",
  "number": "8",
  "title": "",
  "body": "  What is something that you learned from this lesson, or maybe learned better?   "
},
{
  "id": "activities-20",
  "level": "1",
...
{
  "id": "activities-20-4-1",
  "level": "2",
  "url": "activities-20.html#activities-20-4-1",
  "type": "Worksheet Exercise",
  "number": "2",
  "title": "",
  "body": "  We want to find the number of hot dogs eaten in 20 minutes. What would the function notation look like for this problem?          Show your work in finding the answer to previous question.     It approximately 138 hot dogs are eaten in 20 minutes.    "
},
{
  "id": "activities-20-4-2",
  "level": "2",
  "url": "activities-20.html#activities-20-4-2",
  "type": "Worksheet Exercise",
  "number": "3",
  "title": "",
  "body": "  According to the model, how many minutes will it take to eat 100 hot dogs? Show your work using a different method, and round to the nearest whole.    It will take approximately 14 minutes to eat 100 hot dogs.   "
},
{
  "id": "activities-20-4-3",
  "level": "2",
  "url": "activities-20.html#activities-20-4-3",
  "type": "Worksheet Exercise",
  "number": "4",
  "title": "",
  "body": "  Consider the domain:     What does the domain represent in this story; minutes or number of hot dogs eaten?     Minutes.     Does infinity make sense for the situation of a hot dog eating competition? Why or why not?    No. A competition will not go on indefinitely. The contestants will come to a point that they cannot eat anymore hot dogs, or the competition will be timed. Negative time does not exist, so negative infinity would not make sense.      What is the practical domain for this story? Answer in interval or inequality notation, and explain what it means in the context of the problem.    Answer can vary. One example: [0,20] or Which means the competition goes for 20 minutes.      Consider the practical domain you chose. Use the domain values to help you find the practical range and explain what it means. Show work and round values to the nearest whole. Answer in the same notation you used for the domain.    [5,138] or According to the model equation, 5 hot dogs were eaten when time began, and 138 hot dogs eaten at 20 minutes.    "
},
{
  "id": "activities-21",
  "level": "1",
...
{
  "id": "activities-23-2-1",
  "level": "2",
  "url": "activities-23.html#activities-23-2-1",
  "type": "Worksheet Exercise",
  "number": "1",
  "title": "",
  "body": "  Find the slope between and .    The slope is .   "
},
{
  "id": "fig-01-01-2-nonlinear-pattern",
  "level": "2",
  "url": "activities-23.html#fig-01-01-2-nonlinear-pattern",
  "type": "Figure",
  "number": "19",
  "title": "",
...
{
  "id": "activities-23-2-4",
  "level": "2",
  "url": "activities-23.html#activities-23-2-4",
  "type": "Table",
  "number": "20",
  "title": "",
...
{
  "id": "activities-33-3-1",
  "level": "2",
  "url": "activities-33.html#activities-33-3-1",
  "type": "Worksheet Exercise",
  "number": "2",
  "title": "",
...
{
  "id": "activities-33-3-2",
  "level": "2",
  "url": "activities-33.html#activities-33-3-2",
  "type": "Worksheet Exercise",
  "number": "3",
  "title": "",
...
},
{
  ...
  "type": "Handout",
  "number": "",
  "title": "Knowledge Check LT 1-3",
  "body": " Knowledge Check LT 1-3    Tell the story of rainfall over several minutes. Label the axes.    a qualitative graph that starts at the origin and increases, then decreases to the x-axis, and finally increases again.      The rainfall increased at a steady rate for several minutes. It then started to rain less and less, at a steady rate, until it stopped for a few minutes. The rainfall began to increase at a steady rate again.   Sketch the graph of the amount of money in an account over several months according to these parameters:    Your money stays steady for a few months.    Your money grows greatly within one month.    Your money grows greatly within one month.    What is the independent variable? Label the graph.    What is the dependent variable? Label the graph.      A first quadrant graph with a short decreasing line segment up on the y-axis     The independent variable is months, and the dependent variable is amount of money.    A first quadrant graph that starts high on the y-axis and decreases, then is horizontal for a short time, followed by a steep decrease, almost to the x-axis. The graph ends with a horizontal line at this point,       A 3 figure pattern. Figure 1 is an x shape made up of 5 boxes, figure 2 is the same shape with 9 boxes, and figure 3 is the same shape with 13 boxes.    Does the pattern follow a linear pattern? Explain how you know.  What is the rule for the pattern? Show your work.  How many boxes are in the 55th figure? Show your work or explain your thinking.   The pattern is linear because 4 boxes are added each time.  The rule is 4x+1 The constant change (common difference) of 4 is the coefficent on the variable, and subtracting 4 (opposite operation going backward) from the first figure 5, results in the inital value (when x = 0) of 1, which is the constant.  4(55)+1=221 boxes in the 55th figure.    "
},
{
  "id": "handouts-2-2",
  "level": "2",
  ...
  "number": "22",
  "title": "",
  "body": "  Tell the story of rainfall over several minutes. Label the axes.    a qualitative graph that starts at the origin and increases, then decreases to the x-axis, and finally increases again.      The rainfall increased at a steady rate for several minutes. It then started to rain less and less, at a steady rate, until it stopped for a few minutes. The rainfall began to increase at a steady rate again.   Sketch the graph of the amount of money in an account over several months according to these parameters:    Your money stays steady for a few months.    Your money grows greatly within one month.    Your money grows greatly within one month.    What is the independent variable? Label the graph.    What is the dependent variable? Label the graph.      A first quadrant graph with a short decreasing line segment up on the y-axis     The independent variable is months, and the dependent variable is amount of money.    A first quadrant graph that starts high on the y-axis and decreases, then is horizontal for a short time, followed by a steep decrease, almost to the x-axis. The graph ends with a horizontal line at this point,       A 3 figure pattern. Figure 1 is an x shape made up of 5 boxes, figure 2 is the same shape with 9 boxes, and figure 3 is the same shape with 13 boxes.    Does the pattern follow a linear pattern? Explain how you know.  What is the rule for the pattern? Show your work.  How many boxes are in the 55th figure? Show your work or explain your thinking.   The pattern is linear because 4 boxes are added each time.  The rule is 4x+1 The constant change (common difference) of 4 is the coefficent on the variable, and subtracting 4 (opposite operation going backward) from the first figure 5, results in the inital value (when x = 0) of 1, which is the constant.  4(55)+1=221 boxes in the 55th figure.   "
},
{
  "id": "homework",
  "level": "1",
