...
},
{
  ...
  "body": " Independent and Dependent Variables    An independent variable is an input variable whose value can be chosen freely and does not depend on any other variable in the problem or function. It is the variable that you change or manipulate to see how it affects another variable. A dependent variable is the output variable whose value changes in response to, or depends on, the value of the independent variable. It represents the outcome or the result that you are measuring or calculating in a function or problem.      For the following scenarios, determine what the independent and dependent variables are.     A busy student calculates how taking on extra part-time shifts at a local restaurant decreases their available free time for socializing.    Independent Variable:    Dependent Variable:        The campus events board charges $15 per general admission ticket for the annual spring music festival. .    Independent Variable:    Dependent Variable:        A student is trying to determine how the amount of time spent studying affects their test scores.    Independent Variable:    Dependent Variable:        An undergrad tracks their daily caffeine intake from the campus coffee shop to see how it affects their monthly budget.    Independent Variable:    Dependent Variable:        A group of prospective roommates searches for off-campus housing and analyzes how proximity to campus impacts rent prices.    Independent Variable:    Dependent Variable:       "
},
{
  "id": "activities-4-2",
  "level": "2",
