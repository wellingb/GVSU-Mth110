...
},
{
  ...
  "number": "1",
  "title": "",
  "body": "  Fill in the table:        Story  Slope and its meaning  Y-intercept and its Meaning    Farmer Ali had a well on his property 200 feet deep. When the well went dry, he hired a company to drill the well deeper. He used the equation to find the depth of the well, , using the number of days the company drilled, .         Kristina is running the freshman class fundraiser. They are selling key chains. The amount of money they will make is computed using the function , where represents the number of key chains sold, and represents the amount of money made         Jose, the electrician, charges $65 per hour to fix your electrical box issues. He uses the equation to determine the change after working hours.         It costs Corporal Motors $500,000 to outfit their new car line. The company used the equation to detrmine the amount of profit earned from the sale of cars.         Liz has been paying her credit card bill since January 1st, 2026. The eqquation represents the relationship between the number of months that she has been paying, and the amount on her credit card bill .         Abby lights a candle in her kitchen, The height of the candle is represented y the equation , where is the time in hours the candle has been burning, and is the height of the candle in inches.         "
},
{
