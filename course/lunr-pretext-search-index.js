...
},
{
  ...
  "body": " LT 1-2 Tortoise and Hare Adapted from Amplify Classroom and \"Beginning Algebra Made Useful\"     The tortoise and the hare are racing. The tortoise starts at the starting line and runs at a constant speed. The hare also starts at the starting line but runs at a faster pace for several minutes. He then realizes that the tortoise is slow, so he stops to take a nap. When he wakes up, he sees that the tortoise has passed him, so he starts running again to the finish line.     Use the information provided to answer the following questions:    Which animal does each function represent in the graph? Label the graph with \"Tortoise\" and \"Hare\".  Explain your thinking.    A distance and time graph with a constant increasing graph starting at (0,0), and a linear graph that increases, then is constant, and ends increasing.        What is the tortoises speed?      What is the hare's average speed? (find all three speeds and divide by three)    Who won the race? How do you know?      This graph shows the relationship between the distance and time for a third animal, the fox.    Tell a story about the fox's journey during the race. Include specific details about time and distance.    A distance and time graph with a constant graph starting at (9,0), a linear graph that increases, then is constant, and ends increasing, and a third graph that starts at (6,0) and is constant        What is the rox's speed?      Here are five statements about the race. Select all the true statements.    A. The fox's distance was always increasing.    B. Between 6 and 10 minutes, the fox was traveling faster than the other animals.    C. When the hare reached 800 meters, the fox was still at the starting line.         LT 1: We will now be drawing the stories     Next the tortoise raced the dog.  Draw a graph representing the relationship between distance and time for a dog that makes all of these statements true.    The dog got a head start but lost the race.    The dog and tortoise were tied at 600 meters    The dog's distance was decreasing for 3 minutes.      Time and distance graph with tortoise's steady race graphed from (0,0)        The graph shows what Wyatt drew to represent the dog's race. How did she do? Is it accurate according to the statements above?  At least one of the following statements is false Circle the false statement.    A. The dog gor a head start but lost the race    The dog and tortoise were tied at 800 meters.    The dog's distance was decreasing for 3 minutes.      Time and distance graph with tortoise graphed and dog's graph starts at (2,0) and increases for a while, then is constant for several minutes, and then increases again.      Explain your thinking     "
},
{
  "id": "activities-4-2",
  "level": "2",
